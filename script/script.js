...
darkModeToggle.addEventListener('change', () => {
    if (darkModeToggle.checked) {
        ...
        let up = document.querySelector(".uv-li");
        up.setAttribute("style" , "background-color = white");
    }
});
...
// It will display the date as DD-MM-YYYY 
...
console.log(`${currentYear}-${currentMonth}-${Number(currentDay)+1}`);
        ...
        async function defaultWeather(){
            const responseDefault=await fetch(apiUrl+`${apiKey}&q=galle`);
            var data=await responseDefault.json();

            const responseDefault1=await fetch(apiUrlF+`${apiKey}&q=galle&days=7`);
            var dataDefault=await responseDefault1.json();

            const responseDefault2=await fetch(apiUrlH+`${apiKey}&q=galle&dt=`+currentDate);
            var historyDefault=await responseDefault2.json();
            console.log(historyDefault);
            ...
            document.querySelector(".tom-temp").innerHTML = dataDefault.forecast.forecastday[1].day.avgtemp_c + "°C";
            document.querySelector(".t-humidity").innerHTML = dataDefault.forecast.forecastday[1].day.avghumidity + "%";
            document.querySelector(".t-wind").innerHTML = Math.round(dataDefault.forecast.forecastday[1].day.maxwind_kph) + " km/h";
            document.querySelector(".t-rain").innerHTML = dataDefault.forecast.forecastday[1].day.daily_chance_of_rain + "%";
            document.querySelector(".t-uv").innerHTML = dataDefault.forecast.forecastday[1].day.uv + "eV";

            document.querySelector(".yest-temp").innerHTML = historyDefault.forecast.forecastday[0].day.avgtemp_c + "°C";
            document.querySelector(".y-humidity").innerHTML = historyDefault.forecast.forecastday[0].day.avghumidity + "%";
            document.querySelector(".y-wind").innerHTML = Math.round(historyDefault.forecast.forecastday[0].day.maxwind_kph) + " km/h";
            document.querySelector(".y-vision").innerHTML = historyDefault.forecast.forecastday[0].day.avgvis_km + " km";
            document.querySelector(".y-uv").innerHTML = historyDefault.forecast.forecastday[0].day.uv + "eV";
            ...
            document.querySelector(".date2").innerHTML=dataDefault.forecast.forecastday[1].date;
            document.querySelector(".date3").innerHTML=dataDefault.forecast.forecastday[2].date;
            //document.querySelector(".date4").innerHTML=dataDefault.forecast.forecastday[3].date;
            //document.querySelector(".date5").innerHTML=dataDefault.forecast.forecastday[4].date;
            //document.querySelector(".date6").innerHTML=dataDefault.forecast.forecastday[5].date;

            document.querySelector(".humidity1").innerHTML=dataDefault.forecast.forecastday[0].day.avghumidity+"%";
            document.querySelector(".humidity2").innerHTML=dataDefault.forecast.forecastday[1].day.avghumidity+"%";
            document.querySelector(".humidity3").innerHTML=dataDefault.forecast.forecastday[2].day.avghumidity+"%";
            //document.querySelector(".humidity4").innerHTML=dataDefault.forecast.forecastday[3].day.avghumidity+"%";
            //document.querySelector(".humidity5").innerHTML=dataDefault.forecast.forecastday[4].day.avghumidity+"%";
            //document.querySelector(".humidity6").innerHTML=dataDefault.forecast.forecastday[5].day.avghumidity+"%";

            document.querySelector(".tempreature1").innerHTML=dataDefault.forecast.forecastday[0].day.avgtemp_c + "°C";
            document.querySelector(".tempreature2").innerHTML=dataDefault.forecast.forecastday[1].day.avgtemp_c + "°C";
            document.querySelector(".tempreature3").innerHTML=dataDefault.forecast.forecastday[2].day.avgtemp_c + "°C";
            //document.querySelector(".tempreature4").innerHTML=dataDefault.forecast.forecastday[3].day.avgtemp_c + "°C";
           // document.querySelector(".tempreature5").innerHTML=dataDefault.forecast.forecastday[4].day.avgtemp_c + "°C";
            //document.querySelector(".tempreature6").innerHTML=dataDefault.forecast.forecastday[5].day.avgtemp_c + "°C";

            document.querySelector(".wind-speed1").innerHTML=Math.round(dataDefault.forecast.forecastday[0].day.maxwind_kph) + " km/h";
            document.querySelector(".wind-speed2").innerHTML=Math.round(dataDefault.forecast.forecastday[1].day.maxwind_kph) + " km/h";
            document.querySelector(".wind-speed3").innerHTML=Math.round(dataDefault.forecast.forecastday[2].day.maxwind_kph) + " km/h";
           // document.querySelector(".wind-speed4").innerHTML=Math.round(dataDefault.forecast.forecastday[3].day.maxwind_kph) + " km/h";
            //document.querySelector(".wind-speed5").innerHTML=Math.round(dataDefault.forecast.forecastday[4].day.maxwind_kph) + " km/h";
            //document.querySelector(".wind-speed6").innerHTML=Math.round(dataDefault.forecast.forecastday[5].day.maxwind_kph) + " km/h";
        ...
        async function checkWeather(city){
            ...
            document.querySelector(".humidity1").innerHTML=data2.forecast.forecastday[0].day.avghumidity+"%";
            ...
            document.querySelector(".tempreature1").innerHTML=data2.forecast.forecastday[0].day.avgtemp_c + "°C";
           ...
           // document.querySelector(".tempreature5").innerHTML=data2.forecast.forecastday[4].day.avgtemp_c + "°C";
            ...
            document.querySelector(".wind-speed1").innerHTML=Math.round(data2.forecast.forecastday[0].day.maxwind_kph) + " km/h";
        ...
        async function searchHistory(date){

            const response=await fetch(apiUrlH+`${apiKey}&q=galle&dt=`+date);
            var data=await response.json();

            document.querySelector(".date7").innerHTML=date;
            //document.querySelector(".humidity7").innerHTML=data.forecast.forecastday.day.avghumidity + "%";
            //document.querySelector(".tempreature7").innerHTML=data.forecast.forecastday.day.avgtemp_c + "°C";
            //document.querySelector(".wind-speed7").innerHTML=Math.round(data.forecast.forecastday.day.maxwind_kph) + " km/h";
        }
        ...
        document.getElementById("searchweatherBtn").addEventListener("click",()=>{
            searchHistory(document.getElementById("searchweatherInput").value);
        })
